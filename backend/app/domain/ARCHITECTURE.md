...
1. `Ledger` is the top-level container because obligations and categories must belong to a shared business space instead of being copied per user. Sharing access is granted to the same ledger data.
