...
export class AnalyticsService {
     ...
     * @param data._from
     * @param data.to
     * @returns ObligationPeriodTotalsPublic Successful Response
     * @throws ApiError
     */
    public static readObligationPeriodTotals(data: AnalyticsReadObligationPeriodTotalsData): CancelablePromise<AnalyticsReadObligationPeriodTotalsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
